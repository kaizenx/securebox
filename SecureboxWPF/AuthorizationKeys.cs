...
namespace SecureboxWPF
{
    ...
    public static class AuthorizationKeys
    {
        ...
        public static string DropBox_Client_Id = "3utshttechsyys4"; //"Replace_your_DropBox_Client_Id";
        public static string DropBox_Client_Secret = "oohr09xc07xu3yx"; //"Replace_your_DropBox_Client_Secret";
    }
}
